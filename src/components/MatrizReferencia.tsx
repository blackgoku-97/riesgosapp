...
export function MatrizReferencia() {
  return (
    <View className="mt-3 p-3 rounded-md bg-neutral-100 dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700">
      ...
      <Text className="text-neutral-700 dark:text-neutral-300">
        Si el producto es mayor a 6: <Text className="font-bold">Alto Potencial</Text>
      </Text>
      <Text className="text-neutral-700 dark:text-neutral-300">
        Si es 6 o menor: <Text className="font-bold">Bajo Potencial</Text>
      </Text>
    </View>
  );
}